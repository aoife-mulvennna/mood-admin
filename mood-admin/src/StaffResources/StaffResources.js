            ...
            <div className="mb-4 bg-gray-50 p-4">
                ...
                <div className="flex justify-end">
                    <button
                        ...
                        className="bg-green-600 text-white px-4 py-2 hover:bg-green-800 transition"
                    >
                ...
                <table className="min-w-full bg-white border border-gray-300">
                    <thead>
                        <tr className="bg-gray-100">
                            ...
                            <th className="px-4 py-2 text-center border-b">Upload Date</th>
                            <th className="px-4 py-2 text-center border-b">Topic</th>
                    ...
                    <tbody>
                        {filteredResources.map((resource, index) => (
                            <tr key={index} className="hover:bg-gray-50">
                                ...
                                <td className="px-4 py-2 text-center border-b text-sm text-gray-500">
                                    {new Date(resource.resource_added_date).toLocaleDateString()}
                                </td>
                                <td className="px-4 py-2 text-center border-b text-sm text-gray-700">
                                    {resource.resource_topic_name}
                                </td>
                                <td className="px-4 py-2 text-center border-b">
                                    {deleteResourceId === resource.resource_id ? (
                                        <div className="flex flex-col items-center">
                                            <p className="text-black-600 mb-2 text-center">Are you sure?</p>
                                            <div className="flex">
                                                <button onClick={() => handleDeleteResource(resource.resource_id)} className="text-black-600 hover:text-red-600 mr-2">
                                                    Yes
                                                </button>
                                                <button onClick={cancelDelete} className="text-black-600 hover:text-gray-600">
                                                    No
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <button onClick={() => confirmDeleteResource(resource.resource_id)} className="text-red-500 hover:text-red-700">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
