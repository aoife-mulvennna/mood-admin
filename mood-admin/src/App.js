...
import ForgotStaffPassword from './Login/ForgotStaffPassword';
import ResetStaffPassword from './Login/ResetStaffPassword';
    ...
    <div className="bg-gray-100 text-gray-900">
      {showTopBar && token && (
        <header className="bg-gray-800 text-white flex justify-between items-center px-4 h-20">
          ...
          <nav className="hidden lg:flex flex-1 justify-between items-center ml-8">
            <div className="flex space-x-4">
              <NavLink
                className={({ isActive }) => isActive ? 'text-white font-semibold bg-gray-700 px-4 py-2' : 'text-gray-200 bg-gray-600 font-semibold px-4 py-2 hover:text-white'}
                to="/staffdashboard"
              >
                Dashboard
              </NavLink>
            ...
            <div className="flex space-x-4">
              <NavLink
                className="bg-gray-700 text-gray-200 hover:bg-gray-800 hover:text-white font-semibold px-4 py-2"
                to="/stafflogout"
              >
                Logout
              </NavLink>
      ...
      <main className="p-6">
        <Routes>
          ...
          <Route path="/forgot-staff-password" element={<ForgotStaffPassword />} />
          <Route path="/reset-staff-password" element={<ResetStaffPassword />} />
          {/* Private Routes */}
